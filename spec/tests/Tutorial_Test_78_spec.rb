...
class TutorialTest78 < Test::Unit::TestCase
	def setup
	...
	def test_playback_78
		@selenium_helper.get_url('https://floower.bitbucket.io/pages/index.html')
		@selenium_helper.type_by_xpath("/HTML/BODY/[@id='wrapper']/NAV:nth-child(1)/DIV:nth-child(3)/DIV:nth-child(1)/[@id='side-menu']/LI:nth-child(1)/DIV:nth-child(1)/INPUT:nth-child(1)","fuck_off_jordan")

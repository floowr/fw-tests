...
class Playback_ForceFail1_20170307221012099402000 < Test::Unit::TestCase
	def setup 
	...
	def test_playback_20170307221012099423000
			@driver.get(@base_url)
			...
			@driver.find_element(:xpath => "/html/body/div[@id='wrapper']/nav[contains(@class, 'navbar navbar-default navbar-static-top')]/div[contains(@class, 'navbar-default sidebar')]/div[contains(@class, 'sidebar-nav navbar-collapse')]/ul[@id='side-menu']/li[contains(@class, 'sidebar-search')]/div[contains(@class, 'input-group custom-search-form')]/span[contains(@class, 'input-group-btn')]/button[contains(@class, 'btn btn-defaultFORCE_FAIL')]").click

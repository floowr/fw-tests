...
class PrerequisiteTutorialTest < Test::Unit::TestCase
	 ...
	 def self.test_playback
		 ...
		 @selenium_helper.execute_actions([{"id"=>0, "type"=>"change", "path"=>"HTML > BODY > DIV#wrapper > NAV:nth-child(1) > DIV:nth-child(3) > DIV:nth-child(1) > UL#side-menu > LI:nth-child(1) > DIV:nth-child(1) > INPUT:nth-child(1)", "element_name"=>nil, "value"=>""}, {"id"=>1, "type"=>"click", "path"=>"HTML > BODY > DIV#wrapper > NAV:nth-child(1) > DIV:nth-child(3) > DIV:nth-child(1) > UL#side-menu > LI:nth-child(1) > DIV:nth-child(1) > SPAN:nth-child(2) > BUTTON:nth-child(1)", "element_name"=>nil, "value"=>""}])
	 end
end
